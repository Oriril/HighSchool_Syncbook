...
require_once("/var/www/html/Syncbook/src/SabreDAV/CardDAV/cardDAVManagement.php");
require_once("/var/www/html/Syncbook/src/SabreDAV/CardDAV/contactMapper.php");
require_once("/var/www/html/Syncbook/src/SabreDAV/CardDAV/vCardManagement.php");
...
class ContactController extends Controller {
    ...
    public function applyChangesToContact() {
        ...
        // Checking if all went well
        if ($addressBook !== FALSE) {
            // Mapping vCardData from Form
            $vCardData = mapperObjectCard(json_decode(ContactModel::buildNewContact()));
            // Updating vCard into Database
            vCardUpdate($addressBook, $vCardData);
        }
    }
} 