...
class View
{
    ...
    public function renderWithoutHeaderAndFooter($filename, $data = null)
    {
        ...
        //require Config::get('PATH_VIEW') . /*$filename .*/ 'contact/addContact.php';
        require '/var/www/html/Syncbook/src/huge/application/view/contact/addContact.php';
	// require '../view/contact/' . $filename . '.php';
    }
