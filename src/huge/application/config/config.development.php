<?php
//require_once($_SERVER['DOCUMENT_ROOT'] . "/Syncbook/cfg/configurationInclude.php");	//ABSOLUTE PATH ADDED, OLD LINE
require_once("/var/www/html/Syncbook/cfg/configurationInclude.php");
//require_once($_SERVER['DOCUMENT_ROOT'] . "/Syncbook/cfg/configurationClass.php");	//ABSOLUTE PATH ADDED, OLD LINE
...
return array(
	...
	'DB_NAME' => $config['DATABASE']['DATABASE_USER_LIST']['DB_NAME'],
	'DB_USER' => $config['DATABASE']['DATABASE_USER_LIST']['USERNAME'],
	'DB_PASS' => $config['DATABASE']['DATABASE_USER_LIST']['PASSWORD'],
	'DB_PORT' => '3306',
	'DB_CHARSET' => 'utf8',
	/**
	...
	'EMAIL_PASSWORD_RESET_FROM_EMAIL' => 'no-reply@syncbook.me',
	'EMAIL_PASSWORD_RESET_FROM_NAME' => 'Syncbook',
	'EMAIL_PASSWORD_RESET_SUBJECT' => 'Password reset for Syncbook.me',
	'EMAIL_PASSWORD_RESET_CONTENT' => 'Please click on this link to reset your password: ',
	'EMAIL_VERIFICATION_URL' => 'login/verify',
	'EMAIL_VERIFICATION_FROM_EMAIL' => 'no-reply@syncbook.me',
	'EMAIL_VERIFICATION_FROM_NAME' => 'Syncbook',
	'EMAIL_VERIFICATION_SUBJECT' => 'Account activation for Syncbook.me',
	'EMAIL_VERIFICATION_CONTENT' => 'Hi! Thank you for subscribing. Please click on this link to activate your account: ',
);
