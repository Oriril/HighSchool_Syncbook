<div class="container" style="height: 100%;">
    <div class="section margin-15" id="intro">
        <div class="hoja"><img class="center" src="https://syncbook.me/images/logo.png"/></div>
    ...
    <div class="section margin-15" id="services">
        ...
        <div class="row margin-15">
            <div class="col-sm-4">
                <img class="center" src="https://syncbook.me/images/bootstrap.png">
            ...
            <div class="col-sm-4">
                <div>
                    <img class="center" src="https://syncbook.me/images/responsive.png">
            ...
            <div class="col-sm-4">
                <div>
                    <img class="center" src="https://syncbook.me/images/lock.png">
                    <h3>Web Security</h3>
                    <p>
        ...
        <div class="row margin-15">
            <div class="col-lg-3">
                <a href="http://www.php.net" target="_blank">
                    <img class="img-responsive center" src="https://syncbook.me/images/php5.png">
                </a>
            </div>

            <div class="col-lg-3">
                <a href="http://www.w3schools.com/html/html5_intro.asp" target="_blank">
                    <img class="img-responsive center" src="https://syncbook.me/images/html5.png">
                </a>
            </div>

            <div class="col-lg-3">
                <a href="http://www.w3schools.com/css/css3_intro.asp" target="_blank">
                    <img class="img-responsive center" src="https://syncbook.me/images/css3.png">
                </a>
            </div>

            <div class="col-lg-3">
                <a href="https://jquery.com/" target="_blank">
                    <img class="img-responsive center" src="https://syncbook.me/images/jquery.png">
                </a>
            </div>
        </div>
        <div class="row margin-15">
            <div class="col-lg-6">
                <a href="http://sabre.io/" target="_blank">
                    <img class="img-responsive float-left" src="https://syncbook.me/images/sabredav.png">
                </a>
            </div>

            <div class="col-lg-6">
                <a href="https://www.github.com" target="_blank">
                    <img class="img-responsive float-right" src="https://syncbook.me/images/github.png">
                </a>
            </div>
        </div>
    </div>
                ...
                <div class="well no-padding" style="padding: 0px;">
                    <div class="card hovercard" style="display: block;">
                        ...
                        <div class="bottom">
                            ...
                            <a class="btn btn-material-blue-400 btn-twitter btn-sm" href="https://twitter.com/enricobasso01">
                                <i class="fa fa-twitter"></i>
                            </a>
                        </div>
                    </div>
