<div class="container">
    ...
    <div class="login-box" style="width: 50%; display: block;">
        ...
        <form method="post" action="<?php echo Config::get('URL'); ?>login/register_action">
            ...
            <input type="text" pattern="[a-zA-Z]{2,64}" name="user_firstname" placeholder="Your first name (letters)" required/>
            <input type="text" pattern="[a-zA-Z]{2,64}" name="user_lastname" placeholder="Your last name (letters)" required/>
